...
const Sidebar = () => {
  ...
  return (
    <div
      ref={sidebarRef}
      className="flex flex-col h-screen overflow-y-auto overflow-x-hidden pb-10 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-700"
    >
      {/* ── Header / Brand ── */}
      <div className="flex justify-between items-center px-4 pt-5 pb-4 border-b border-gray-100 dark:border-gray-800">
        ...
        >
          <span className="text-xs font-semibold tracking-[0.2em] uppercase text-gray-400 dark:text-gray-500 group-hover:text-gray-500 transition-colors">
            K.A
          </span>
          <span className="text-base font-extrabold tracking-tight text-gray-800 dark:text-white leading-tight group-hover:opacity-80 transition-opacity">
            Hotel & Suites
          </span>
        </Link>
      ...
      <div className="px-2 pt-3 border-t border-gray-100 dark:border-gray-800 mt-auto">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-150"
        >
